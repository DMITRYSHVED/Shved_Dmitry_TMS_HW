...
public class VectorTwoD {
    ...
    public static double findVectorLength(VectorTwoD vector) {
        double length;
        length = Math.sqrt(Math.pow(vector.getCoordinateX(), 2) + Math.pow(vector.getCoordinateY(), 2));
        return length;
    }

    public static double findScalar(VectorTwoD firstVector, VectorTwoD secondVector) {
    ...
    public static VectorTwoD vectorAddition(VectorTwoD firstVector, VectorTwoD secondVector) {
        double sumVectorX;
        double sumVectorY;
    ...
    public static VectorTwoD vectorSubtraction(VectorTwoD firstVector, VectorTwoD secondVector) {
        double minusVectorX;
        double minusVectorY;
    ...
    public static void compareVectors(VectorTwoD firstVector, VectorTwoD secondVector) {
